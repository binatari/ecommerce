...
function ProductPage({ product }) {
  ...
  return (
    <React.Fragment>
      ...
      <div className="md:min-h-screen md:flex md:items-center container mx-auto">
        <div className="flex flex-col-reverse md:flex-row space-y-3 md:space-y-0 md:space-x-10">
          <div className="md:max-h-screen md:w-1/2 flex flex-col md:flex-row items-end justify-between md:sticky md:top-0">
            ...
            <motion.div
              className="py-6 px-4 md:py-12 sticky top-0"
      ...
      <div className="container mx-auto py-3 md:py-4 lg:py-8">
